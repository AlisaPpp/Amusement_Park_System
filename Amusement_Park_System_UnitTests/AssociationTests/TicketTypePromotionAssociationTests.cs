...
namespace Amusement_Park_System_Tests
{
    ...
    {
        private TicketType ticketType1 = null!;
        private TicketType ticketType2 = null!;
        private Promotion promotion1 = null!;
        private Promotion promotion2 = null!;
        ...
        public void Setup()
        {
            ...
            promotion1 = new Promotion("Summer Sale", DateTime.Now.Date, DateTime.Now.Date.AddDays(30), 20);
            promotion2 = new Promotion("Winter Sale", DateTime.Now.Date, DateTime.Now.Date.AddDays(60), 30);
        }
        ...
        public void TestTicketTypePriceCalculationWithPromotion()
        {
            ...
            var ticket = new Ticket(DateTime.Now.Date.AddDays(1), DateTime.Now.Date.AddDays(2), 0, 1, ticketType1, order);
        ...
        [Test]
        public void TestExpiredPromotionConstructorThrows()
        {
            Assert.Throws<ArgumentException>(() =>
                new Promotion("Expired", DateTime.Now.Date.AddDays(-10), DateTime.Now.Date.AddDays(-1), 50));
        }

        [Test]
        public void TestStaticRemoveExpiredPromotions_DoesNotRemoveNonExpiredToday()
        {
            var todayEndsToday = new Promotion("EndsToday", DateTime.Now.Date, DateTime.Now.Date, 10);

            Promotion.RemoveExpiredPromotions();

            Assert.That(Promotion.Extent, Contains.Item(todayEndsToday));
        }
        ...
        public void TestTicketTypesCollectionIsReadOnly()
        {
            ...
            Assert.That(promotion1.TicketTypes, Is.InstanceOf<IReadOnlyCollection<TicketType>>());
        }
    }
}
